        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((image, index) => (
            ...
            >
              ...
              >
                <div className="text-rider-blue text-sm font-semibold mb-2">
                  {image.category}
                </div>
              ...
              {/* Border Effect */}
              <motion.div
                className="absolute inset-0 border-2 border-rider-blue opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl"
                initial={false}
              />

              {/* Light Effect */}
              <motion.div
                className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-rider-blue/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                initial={false}
              />
            </motion.div>
          ))}
