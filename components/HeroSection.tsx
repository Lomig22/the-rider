...
const HeroSection = () => {
  return (
    <section id="hero" className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
        ...
        >
          ...
          >
            <motion.a
              href="#identity"
              className="px-8 py-4 bg-rider-blue text-white text-lg font-semibold rounded-full hover:bg-rider-lightBlue transition-colors duration-300 shadow-lg"
      ...
      >
        <div className="h-full w-full bg-gradient-to-r from-transparent via-rider-blue/20 to-transparent transform skew-x-12" />
      </motion.div>
    </section>
  )
}
