      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-8 rounded-2xl border border-gray-700 hover:border-[#0066FF] transition-all duration-300 h-full">
                ...
                {/* Hover overlay */}
                <motion.div
                  className="absolute inset-0 bg-[#0066FF]/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                  initial={false}
                />
              </div>
            </motion.div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="gradient-blue p-12 rounded-3xl text-center shadow-2xl">
            ...
            <motion.a
              href="#contact"
              className="inline-block px-10 py-4 bg-white text-[#0066FF] text-lg font-bold rounded-full hover:bg-gray-100 transition-colors duration-300 shadow-lg"
          ...
          {/* Glow effect */}
          <div className="absolute -inset-1 bg-gradient-to-r from-[#0066FF] to-[#4D94FF] rounded-3xl blur opacity-30 -z-10" />
        </motion.div>
      </div>
