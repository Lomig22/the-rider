      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Accent Blue Border */}
            <motion.div
              className="absolute -bottom-4 -right-4 w-full h-full border-4 border-[#0066FF] rounded-2xl -z-10"
          ...
          >
            ...
            >
              <p className="leading-relaxed">
                <span className="text-[#0066FF] font-semibold">Jordan</span> n'est pas juste un pilote,
