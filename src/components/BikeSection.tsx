        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-[#0066FF] font-semibold">performance pure</span>. 
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              {bikeSpecs.map((spec, index) => (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl border border-gray-700 hover:border-[#0066FF] transition-all duration-300"
                >
                  <spec.icon className="text-[#0066FF] text-3xl mb-3" />
          ...
          >
            ...
            {/* Accent Effect */}
            <motion.div
              className="absolute -top-4 -left-4 w-full h-full border-4 border-[#0066FF] rounded-2xl -z-10"
            ...
            {/* Glow Effect */}
            <motion.div
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#0066FF]/20 rounded-full blur-3xl -z-20"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.3, 0.5, 0.3],
              }}
